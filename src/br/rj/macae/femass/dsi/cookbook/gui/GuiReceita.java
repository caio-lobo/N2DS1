...
public class GuiReceita extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        receita1 = new br.rj.macae.femass.dsi.cookbook.modelo.Receita();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if(tblReceitas.getSelectedRow()>=0){
            ...
            try {
                limparCampos();
                ReceitaE r = controle.getReceitaPorId((Long) valor);
                ...
                model.clear();
                for(Receita_IngredienteE ri: r.getIngredientes()){
                    model.addElement(ri);
                }
                habilitarCampos();
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        if(tblReceitas.getSelectedRow()>=0){
            ...
            Object valor=((DefaultTableModel)tblReceitas.getModel()).getValueAt(tblReceitas.getSelectedRow(), 0);
            try {
                ReceitaE i = controle.getReceitaPorId((Long) valor);                
                controle.excluir(i);
                atualizarLista();
                desabilitarCampos();
            } catch (SQLException ex) {
    ...
    private void btnAdIngredienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdIngredienteActionPerformed
        Receita_IngredienteE ri = new Receita_IngredienteE();
        ri.setIngrediente((IngredienteE)txtIngrediente.getSelectedItem());        
        ri.setReceita(null);
    ...
    private javax.swing.JList<Receita_IngredienteE> lstIngreditantes;
    private br.rj.macae.femass.dsi.cookbook.modelo.Receita receita1;
